...
import History from '../../packages/@shapeci/slate-history/package.json'
import Hyperscript from '../../packages/@shapeci/slate-hyperscript/package.json'
import React from '../../packages/@shapeci/slate-react/package.json'
import Core from '../../packages/@shapeci/slate/package.json'
