import { BaseEditor,Editor,Node,Path,Point,Range,Transforms } from '@shapeci/slate'
import {
  DOMElement,
  DOMNode,
  DOMPoint,
  DOMRange,
  DOMSelection,
  DOMStaticRange,hasShadowRoot,isDOMElement,
  isDOMSelection,
  normalizeDOMPoint
} from '../utils/dom'
...
import {
  EDITOR_TO_ELEMENT,EDITOR_TO_KEY_TO_ELEMENT,EDITOR_TO_WINDOW,ELEMENT_TO_NODE,
  IS_FOCUSED,
  IS_READ_ONLY,
  NODE_TO_INDEX,
  NODE_TO_KEY,
