import { Editor, Node, Operation, Path, Range, Transforms } from '@shapeci/slate'
import ReactDOM from 'react-dom'
import {
    getPlainText,
    getSlateFragmentAttribute, isDOMText
} from '../utils/dom'
import { Key } from '../utils/key'
import { findCurrentLineRange } from '../utils/lines'
import {
    EDITOR_TO_KEY_TO_ELEMENT,
    EDITOR_TO_ON_CHANGE, EDITOR_TO_USER_SELECTION, NODE_TO_KEY
