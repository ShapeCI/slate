import { Editor,Element,Node,Path,Range,Transforms } from '@shapeci/slate'
...
import {
  DOMElement,getClipboardData,getDefaultView,isDOMElement,
  isDOMNode
} from '../../utils/dom'
import {
  EDITOR_ON_COMPOSITION_TEXT,EDITOR_TO_ELEMENT,
  EDITOR_TO_WINDOW,
  ELEMENT_TO_NODE,IS_COMPOSING,IS_FOCUSED,IS_ON_COMPOSITION_END,IS_READ_ONLY,
  NODE_TO_ELEMENT,
  PLACEHOLDER_SYMBOL
} from '../../utils/weak-maps'
import { defaultDecorate,EditableProps,hasEditableTarget,hasTarget,isDOMEventHandled,isEventHandled,isTargetInsideNonReadonlyVoid } from '../editable'
