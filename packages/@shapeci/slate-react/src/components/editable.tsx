...
import {
  CAN_USE_DOM,HAS_BEFORE_INPUT_SUPPORT,IS_CHROME,
  IS_FIREFOX,
  IS_FIREFOX_LEGACY,IS_IOS,IS_QQBROWSER,
  IS_SAFARI,
  IS_UC_MOBILE,
  IS_WECHATBROWSER
...
import {
  EDITOR_TO_ELEMENT,EDITOR_TO_USER_SELECTION,EDITOR_TO_WINDOW,ELEMENT_TO_NODE,IS_FOCUSED,IS_READ_ONLY,
  NODE_TO_ELEMENT,PLACEHOLDER_SYMBOL
